...
from phototag.update_image import KEYWORD_KEYS, add_keywords_to_metadata, read_metadata, remove_all_keywords_from_metadata, write_metadata
...
print("======= Before =======")
print_tags(metadata)
metadata=remove_all_keywords_from_metadata(metadata)
print("======= After remove =======")
print_tags(metadata)
